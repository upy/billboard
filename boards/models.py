...
class Board(models.Model):
    ...
    MAIN = 1
    INTERMEDIATE = 2
    ARTERIES = ((MAIN, _("Main artery")), (INTERMEDIATE, _("Intermediate artery")))

    number = models.CharField(_("Number"), max_length=255)
    comment = models.TextField(_("Comment"))
    style = models.PositiveSmallIntegerField(_("Style"), choices=STYLES, db_index=True)
    ...
    artery = models.PositiveSmallIntegerField(
        _("Artery type"), db_index=True, choices=ARTERIES
    )
